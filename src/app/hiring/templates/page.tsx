// src/app/hiring/templates/page.tsx (or wherever this file lives)
"use client";
          ...
          >
            ...
            <div className="space-y-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
                ...
                <div className="flex items-end">
                  <label className="inline-flex items-center gap-2 text-xs text-slate-700">
                    <input
                      ...
                      onChange={(e) =>
                        setDraftQuestionRequired(e.target.checked)
                      }
              ...
              <p className="mt-1 text-[11px] text-slate-500">
                You can always edit questions later. This just seeds the
                template with a starting screen.
              </p>
            </div>
