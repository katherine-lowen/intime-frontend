  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        data-slot="chart"
        data-chart={chartId}
        // ⬇️ Explicit width + height, no aspect ratio
        className={cn(
          "flex h-[320px] w-full justify-center text-xs",
      ...
      >
        ...
        {/* ⬇️ Make Recharts obey the container size */}
...
// Very loose typings here on purpose to avoid the TS issues with Recharts generics.
type TooltipItem = {
  name?: string;
  dataKey?: string;
  color?: string;
