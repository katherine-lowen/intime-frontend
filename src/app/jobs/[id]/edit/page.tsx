...
export default function EditJobPage() {
  ...
  const [applicationTemplateId, setApplicationTemplateId] = useState<string>("");
  ...
  useEffect(() => {
    async function loadTemplates() {
      ...
      try {
        const res = await fetch(`${API_URL}/hiring/templates`, {
        ...
        // soft-fail; edit still works without templates
      } finally {
      ...
      <section className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-600">
            Update details for this opening. Changes flow through to the public job board and ATS.
          </p>
        </div>
        ...
        >
          ...
          <section className="space-y-4">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
              ...
              <p className="mt-1 text-xs text-slate-500">
                Control whether this role appears on your public careers page, and which application template is used.
              </p>
              ...
              <div className="mt-3 space-y-3 text-sm">
                <label className="inline-flex items-start gap-2 text-xs text-slate-700">
                  ...
                  <span>
                    ...
                    <span className="block text-[11px] text-slate-500">
                      When enabled and status is OPEN, this role appears on your /careers page.
                    </span>
                  </span>
                </label>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100 disabled:bg-slate-50"
                  >
                    <option value="">
                      {loadingTemplates
                        ? "Loading templates…"
