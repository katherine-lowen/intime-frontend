        ...
        >
          <div className="absolute top-0 right-0 opacity-5">
            <svg width="120" height="120" viewBox="0 0 120 120">
              {[10, 30, 50, 70].flatMap((y) =>
                [10, 30, 50, 70].map((x, i) => (
                  <circle key={`${x}-${y}-${i}`} cx={x} cy={y} r="2" fill="#7A5CFA" />
                ))
              )}
            </svg>
          </div>
          ...
          <div className="relative">
            ...
            <div className="space-y-3 text-[#0F1419] leading-relaxed">
              <p>
                <strong>Your organization is performing well this week.</strong>{" "}
                Headcount is stable with 12 new hires in the pipeline across Engineering and Product.
              </p>
              <p>
                Team coverage is healthy across most departments (87% overall), though Design may need
                extra attention next week due to planned leave.
              </p>
