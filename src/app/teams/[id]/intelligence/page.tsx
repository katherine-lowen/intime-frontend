  ...
  try {
    ...
    return (
      <main className="p-6 space-y-4">
        ...
        <h1 className="text-2xl font-semibold">Team intelligence</h1>
        <p className="text-sm text-red-600">
          Failed to load team or people data from the API.
        </p>
      </main>
    );
  }
    ...
    return (
      <main className="p-6 space-y-4">
        ...
        <p className="text-sm text-gray-600">
          We couldn&apos;t find that team. It may have been removed or the link
          is invalid.
        </p>
      </main>
    );
          ...
          <div className="rounded-lg border bg-white p-4 shadow-sm">
            ...
            {members.length === 0 ? (
              <p className="mt-3 text-sm text-gray-600">
                No people currently assigned to this team. Once you start using
                this team name as a department on people records, they&apos;ll
                show here.
              </p>
            ) : (
        ...
        <div className="space-y-4">
          <div className="rounded-lg border bg-white p-4 shadow-sm">
            ...
            <p className="mt-2 text-sm text-gray-700">
              This view helps you understand who is on <strong>{team.name}</strong>{" "}
              and how they are distributed across roles and locations. As you
              add more people and events to Intime, this panel can evolve into
              a richer time-based view of team health and performance.
            </p>
