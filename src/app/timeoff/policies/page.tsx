...
export default function TimeOffPoliciesPage() {
  ...
  async function fetchPolicies() {
    try {
      ...
      const res = await fetch(`${baseUrl}/timeoff/policies`, {
        headers: {
          "x-org-id": orgId,
        },
      });
  ...
  return (
    <div className="px-6 py-6 space-y-6">
      ...
      <form
        ...
        className="space-y-4 rounded-xl border border-slate-200 bg-white p-4 shadow-sm max-w-xl"
      >
        <div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              />
              <p className="mt-1 text-xs text-slate-500">
                For unlimited policies, employees won&apos;t see a balance limit.
              </p>
            </div>
          </div>
        </div>
