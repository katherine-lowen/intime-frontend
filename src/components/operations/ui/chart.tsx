...
// We still export the raw Recharts components for convenience
const ChartTooltip = RechartsPrimitive.Tooltip;
const ChartLegend = RechartsPrimitive.Legend;

// --- Custom TS-friendly prop types for tooltip / legend ---
...
type ChartTooltipContentProps = React.HTMLAttributes<HTMLDivElement> & {
  ...
  labelFormatter?: (value: any, payload: RechartsPayloadItem[]) => React.ReactNode;
...
function getPayloadConfigFromPayload(
  ...
  if (
    ...
    configLabelKey = innerPayload[
      key as keyof typeof innerPayload
    ] as string;
  }
